...
function game() {
    const attackPower = Math.floor(Math.random() * (40 - 5) + 1) + 5;
    const enemy = enemies[Math.floor(Math.random() * enemies.length)];
    let enemyHealth = 30;
    const enemyPower = Math.floor(Math.random() * (30 - 5) + 1) + 5;
                    ...
                    case 'f':
                        ...
                        if (enemyHealth <= 0) {
                            ...
                            if (loot <= .3) {
                                ...
                                console.log(' You have killed the ' + ' ' + enemy + ' and have found ' + pickUp + 'you also have 15 extra HP');
